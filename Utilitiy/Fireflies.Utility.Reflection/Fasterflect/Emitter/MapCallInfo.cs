...
internal class MapCallInfo {
    ...
    public override bool Equals(object obj) {
        if(!(obj is MapCallInfo other)) return false;
    ...
    public override int GetHashCode() {
        var hashCode = 167991888;
        hashCode = hashCode * -1521134295 + TargetType.GetHashCode();
        hashCode = hashCode * -1521134295 + SourceType.GetHashCode();
        hashCode = hashCode * -1521134295 + Flags.GetHashCode();
        for(int i = 0, count = Sources.Count; i < count; ++i) hashCode = hashCode * -1521134295 + Sources[i].GetHashCode();
        for(int i = 0, count = Targets.Count; i < count; ++i) hashCode = hashCode * -1521134295 + Targets[i].GetHashCode();
        return hashCode;
    }
}