...
public struct FasterflectFlags {
    ...
    private static readonly Dictionary<FasterflectFlags, string> flagNames = new(64);
    ...
    /// </summary>
    public static readonly FasterflectFlags None = new((long)BindingFlags.Default);

    /// <summary>
    ///     This value corresponds to the <see cref="BindingFlags.IgnoreCase" /> value.
    /// </summary>
    public static readonly FasterflectFlags IgnoreCase = new((long)BindingFlags.IgnoreCase);

    /// <summary>
    ///     This value corresponds to the <see cref="BindingFlags.DeclaredOnly" /> value.
    /// </summary>
    public static readonly FasterflectFlags DeclaredOnly = new((long)BindingFlags.DeclaredOnly);
    ...
    /// </summary>
    public static readonly FasterflectFlags ExactBinding = new((long)BindingFlags.ExactBinding);

    /// <summary>
    ///     This value corresponds to the <see cref="BindingFlags.Public" /> value.
    /// </summary>
    public static readonly FasterflectFlags Public = new((long)BindingFlags.Public);

    /// <summary>
    ///     This value corresponds to the <see cref="BindingFlags.NonPublic" /> value.
    /// </summary>
    public static readonly FasterflectFlags NonPublic = new((long)BindingFlags.NonPublic);

    /// <summary>
    ///     This value corresponds to the <see cref="BindingFlags.Instance" /> value.
    /// </summary>
    public static readonly FasterflectFlags Instance = new((long)BindingFlags.Instance);

    /// <summary>
    ///     This value corresponds to the <see cref="BindingFlags.Static" /> value.
    /// </summary>
    public static readonly FasterflectFlags Static = new((long)BindingFlags.Static);
    ...
    /// </summary>
    public static readonly FasterflectFlags PartialNameMatch = new(1L << 32);
    ...
    ///     operations.
    /// </summary>
    public static readonly FasterflectFlags TrimExplicitlyImplemented = new(1L << 33);

    /// <summary>
    ///     If this option is specified the search for members will exclude explicitly implemented
    ///     interface members.
    /// </summary>
    public static readonly FasterflectFlags ExcludeExplicitlyImplemented = new(1L << 34);
    ...
    ///     result.
    /// </summary>
    public static readonly FasterflectFlags ExcludeBackingMembers = new(1L << 35);
    ...
    /// </summary>
    public static readonly FasterflectFlags IgnoreParameterModifiers = new(1L << 36);
    ...
    /// </summary>
    public static readonly FasterflectFlags ExcludeHiddenMembers = new(1L << 37);
    ...
    /// <summary>
    ///     Returns true if at least one of the values in the given <paramref name="mask" /> are set in the current Flags
    ///     instance.
    /// </summary>
    ...
    /// <summary>
    ///     Produces a new Flags instance with the values from the intersection of <paramref name="f1" /> and
    ///     <paramref name="f2" />.
    /// </summary>
    public static FasterflectFlags operator &(FasterflectFlags f1, FasterflectFlags f2) {
        return new FasterflectFlags(f1.flags & f2.flags);
    ...
    public override string ToString() {
        var @this = this;
        var names = flagNames.Where(kvp => @this.IsSet(kvp.Key))
