...
internal static partial class MethodExtensions {
    ...
    /// <summary>
    ///     Create a delegate to invoke a generic method.  See the overload with same parameters except for
    ...
    /// <summary>
    ///     Creates a delegate which can invoke the method <paramref name="name" /> with arguments matching
    ///     <paramref name="parameterTypes" /> and matching <paramref name="bindingFlags" /> on the given
    ///     <paramref name="type" />.
    ///     Leave <paramref name="parameterTypes" /> empty if the method has no arguments.
    /// </summary>
...
internal static partial class MethodExtensions {
    ...
    internal static object CallMethod(this object obj, string name, params object[] parameters) {
        var type = obj.GetTypeAdjusted();
        var parameterTypes = parameters.ToTypeArray();
        var method = DelegateForCallMethod(type, null, name, FasterflectFlags.StaticInstanceAnyVisibility, parameterTypes);
        var value = method(obj, parameters);
        return value;
    }
    ...
    internal static object CallMethod(this object obj, Type[] genericTypes, string name, params object[] parameters) {
        var type = obj.GetTypeAdjusted();
        var parameterTypes = parameters.ToTypeArray();
        var method = DelegateForCallMethod(type, genericTypes, name, FasterflectFlags.StaticInstanceAnyVisibility, parameterTypes);
        var value = method(obj, parameters);
        return value;
    }
    ...
    internal static object CallMethod(this object obj, string name, FasterflectFlags bindingFlags, params object[] parameters) {
        var type = obj.GetTypeAdjusted();
        var parameterTypes = parameters.ToTypeArray();
        var method = DelegateForCallMethod(type, null, name, bindingFlags, parameterTypes);
        var value = method(obj, parameters);
        return value;
    }
    ...
    internal static object CallMethod(this object obj, Type[] genericTypes, string name, FasterflectFlags bindingFlags, params object[] parameters) {
        var type = obj.GetTypeAdjusted();
        var parameterTypes = parameters.ToTypeArray();
        var method = DelegateForCallMethod(type, genericTypes, name, bindingFlags, parameterTypes);
        var value = method(obj, parameters);
        return value;
    }
