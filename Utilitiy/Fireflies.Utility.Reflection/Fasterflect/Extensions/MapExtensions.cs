...
internal static partial class MapExtensions {
    ...
    ///     filter members by substring and <see cref="FasterflectFlags.IgnoreCase" /> to ignore case.
    /// </param>
...
internal static partial class MapExtensions {
    ...
    public static void Map(this object source, object target, params string[] names) {
        ...
        var targetType = target.GetTypeAdjusted();
        var mapper = DelegateForMap(sourceType, targetType, names);
    ...
    public static void Map(this object source, object target, FasterflectFlags bindingFlags, params string[] names) {
        var sourceType = source.GetType();
        var targetType = target.GetTypeAdjusted();
        var mapper = Reflect.Mapper(sourceType, targetType, bindingFlags, names);
        mapper(source, target);
    }
    ...
    /// <param name="names">
    ///     The optional list of field names against which to filter the fields that are
    ///     to be mapped. If this parameter is <see langword="null" /> or empty no name filtering will be applied. The default
    ///     behavior is to check for an exact, case-sensitive match. Pass <see cref="FasterflectFlags.PartialNameMatch" /> to
    ///     filter fields by substring and <see cref="FasterflectFlags.IgnoreCase" /> to ignore case.
    /// </param>
    ...
    /// <param name="names">
    ///     The optional list of property names against which to filter the properties that are
    ///     to be mapped. If this parameter is <see langword="null" /> or empty no name filtering will be applied. The default
    ///     behavior is to check for an exact, case-sensitive match. Pass <see cref="FasterflectFlags.PartialNameMatch" /> to
    ///     filter properties by substring and <see cref="FasterflectFlags.IgnoreCase" /> to ignore case.
    /// </param>
    ...
    ///     to filter members by substring.
    /// </param>
