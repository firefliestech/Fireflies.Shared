...
internal static partial class PropertyExtensions {
    ...
    /// <summary>
    ///     Creates a delegate which can set the value of the property specified by
    ///     <param name="name" />
    ///     on the given
    ///     <param name="type" />
    ///     .
    ...
    /// <summary>
    ///     Creates a delegate which can get the value of the property specified by
    ///     <param name="name" />
    ///     on the given
    ///     <param name="type" />
    ///     .
...
internal static partial class PropertyExtensions {
    ...
    internal static object SetPropertyValue(this object obj, string name, object value) {
        ...
        var setter = DelegateForSetPropertyValue(type, name);
        setter(obj, value);
        return obj;
    }
    ...
    internal static object GetPropertyValue(this object obj, string name) {
        var type = obj.GetTypeAdjusted();
        var getter = DelegateForGetPropertyValue(type, name);
    ...
    internal static object SetPropertyValue(this object obj, string name, object value, FasterflectFlags bindingFlags) {
        var type = obj.GetTypeAdjusted();
        var setter = DelegateForSetPropertyValue(type, name, bindingFlags);
        setter(obj, value);
        return obj;
    }
    ...
    internal static object GetPropertyValue(this object obj, string name, FasterflectFlags bindingFlags) {
        var type = obj.GetTypeAdjusted();
        var getter = DelegateForGetPropertyValue(type, name, bindingFlags);
        var value = getter(obj);
        return value;
    }
    ...
    internal static object SetPropertyValue(this object obj, Expression<Func<object>> memberExpression, object value) {
        ...
        if(body == null || body.Member == null) throw new ArgumentNullException(nameof(memberExpression));
    ...
    ///     The list of the indexer parameters plus the value to be set to the indexer.
    ...
    ///     use a different overload of this method.
    /// </param>
    ...
    /// <param name="parameters">
    ///     The list of the indexer parameters plus the value to be set to the indexer.
    ///     This list must match with the <paramref name="parameterTypes" /> list.
    /// </param>
    /// <returns>The object whose indexer is to be set.</returns>
    /// <example>
    ///     If the indexer is of type <see cref="string" /> and accepts one parameter of type <see langword="int" />, this
    ...
    /// <param name="parameters">
    ///     The list of the indexer parameters.
    ///     The parameter types are determined from these parameters, therefore no parameter can be <see langword="null" />.
    ///     If any parameter is <see langword="null" /> (or you can't be sure of that, i.e. receive from a variable),
    ///     use a different overload of this method.
    /// </param>
    ...
    /// </summary>
    /// <remarks>
    ///     When using this method it is not possible to distinguish between a missing property and a property whose value is
    ///     null.
    /// </remarks>
